...
import { useRetroSFX } from '@/hooks/vibe/useRetroSFX';
import { useChiptune } from '@/hooks/vibe/useChiptune';
import { useAuthenticatedFetch } from '@/hooks/vibe/useAuthenticatedFetch';
import { useUTMTracking } from '@/hooks/vibe/useUTMTracking';
import { useReferralTracking } from '@/hooks/vibe/useReferralTracking';
import { track } from '@/lib/vibe/track';
import type { Agent, AgentStatus, Mood, PendingAction, Accomplishment, ChatMessage } from './types';
import { randomColor, generateAgentDefaults, prettifyTask, formatInterval } from './utils';
import { NPC } from './NPC';
import { Room } from './Room';
import { AgentPanel } from './AgentPanel';
import { SettingsPanel } from './SettingsPanel';
import { CooldownTimer, linkifyFiles, Stat } from './CooldownTimer';
import { TemplateGallery } from './TemplateGallery';
import { DemoBanner } from './DemoBanner';
import { DemoInstallCTA } from './DemoInstallCTA';
...
import { AchievementToastContainer, AchievementToastData } from './AchievementToast';
import { BootSequence } from './BootSequence';
import { MeetingRoom } from './MeetingRoom';
import { AutoworkBanner } from './AutoworkBanner';
import { CallMeetingModal } from './CallMeetingModal';
import { AccomplishmentDetailModal } from './AccomplishmentDetailModal';
        ...
        <div style={{
          ...
          <button
            onClick={async () => {
              ...
              try {
                await Promise.all([
                  fetch(getApiPath('/api/vibe')).then(r => r.json()).then(data => {
                    setAgents(data.agents || []);
                  }),
                  fetch(getApiPath('/api/vibe/actions')).then(r => r.json()).then(d => {
