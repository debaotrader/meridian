...
import { SpeechBubbleOverlay } from "@/components/office-2d/overlays/SpeechBubble";
...
import { calculateDeskSlots, calculateMeetingSeatsSvg } from "@/lib/office/position-allocator";
...
export function FloorPlan() {
  ...
  return (
    <div className="relative h-full w-full bg-surface-1 dark:bg-surface-0">
      <svg
