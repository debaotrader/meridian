import type { CollaborationLink, VisualAgent } from "@/lib/office/types";
import { ZONES } from "@/lib/office/constants";
import { allocateMeetingPositions } from "@/lib/office/position-allocator";
